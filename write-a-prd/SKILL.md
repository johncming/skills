...
5. Once you have a complete understanding of the problem and solution, use the template below to write the PRD. Create `john_plans/` if it doesn't exist, then save as `john_plans/prd-<feature-name>.md`.
